// Copyright 2020-2022, Benjamin Ludewig, Florian Bonetti, Jeffrey Munstermann, Luca Nittscher, Hugo Damer, Michael Bach, Jan Hensel, Hannes Masuch
...
pub fn convert_device_to_fw_rules(
    ...
    if device.q_bit {
        ...
        if device.log_anomalies {
            rules.push(FirewallRule::new(
                format!("rule_log_anomalies_{}", rule_counter),
                Some(RuleTargetHost::FirewallDevice),
                None,
                None,
                None,
                None,
                Verdict::Log(LogGroup::DenialsFromDevice.into()),
            ));
            rule_counter += 1;
            rules.push(FirewallRule::new(
                format!("rule_log_anomalies_{}", rule_counter),
                ...
                None,
                None,
                Verdict::Log(LogGroup::DenialsToDevice.into()),
            ));
            rule_counter += 1;
        }
    ...
    fn test_overridden_acls_to_firewall_rules() {
        ...
        let resulting_device = FirewallDevice {
            ...
            rules: vec![
                ...
                FirewallRule::new(
                    String::from("rule_log_anomalies_7"),
                    Some(RuleTargetHost::FirewallDevice),
                    None,
                    None,
                    None,
                ...
                FirewallRule::new(
                    String::from("rule_log_anomalies_8"),
                    None,
                    Some(RuleTargetHost::FirewallDevice),
                    None,
                    None,
    ...
    fn test_converting() {
        ...
        let expected = FirewallDevice {
            ...
            rules: vec![
                ...
                FirewallRule::new(
                    String::from("rule_log_anomalies_2"),
                    Some(RuleTargetHost::FirewallDevice),
                    None,
                    None,
                    None,
                ...
                FirewallRule::new(
                    String::from("rule_log_anomalies_3"),
                    None,
                    Some(RuleTargetHost::FirewallDevice),
                    None,
                    None,
    ...
    fn test_same_manufacturer() {
        ...
        let resulting_device = FirewallDevice {
            ...
            rules: vec![
                ...
                FirewallRule::new(
                    String::from("rule_log_anomalies_1"),
                    Some(RuleTargetHost::FirewallDevice),
                    None,
                    None,
                    None,
