...
export DNSMASQ_MUD_URL=http://iotanalytics.unsw.edu.au/mud/amazonEchoMud.json
...
cargo run --features "dnsmasq_hook" --bin namib_dnsmasq_hook add aa:bb:cc:dd:ee:ff 192.168.1.15 hostname
#../target/debug/namib_dnsmasq_hook add aa:bb:cc:dd:ee:ff 192.168.1.15 hostname
